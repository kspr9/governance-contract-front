...
<div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <div class="mb-8 card">
                <h2 class="section-header mb-4">Contract Storage (Taquito)</h2>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Registry Number:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.registry_number?.Some || 'Not set'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Max Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.max_shares?.Some || 'Not set'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Issued Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.issued_shares}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Allocated Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.allocated_shares}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">All Shares Issued:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.all_shares_issued ? 'Yes' : 'No'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Contract admin:</span> 
                        <span class="text-[color:var(--foreground)]">{storageData.admin_address}</span>
                    </div>
                </div>

                <!-- Share Owners (Entitled to Claim) -->
                <div class="mt-4">
                    <h3 class="section-header mb-2">Share Owners (Entitled to Claim)</h3>
                    <table class="w-full border-collapse">
                        <thead>
                            <tr>
                                <th class="text-left p-2 table-header">Address</th>
                                <th class="text-right p-2 table-header">Entitled Shares</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            {:else}
                                <tr class="table-row">
                                    <td class="text-center p-2 text-[color:var(--muted-foreground)]" colspan="2">No share owners registered</td>
                                </tr>
                            {/if}
                        </tbody>
                    </table>
                ...
                <div class="mt-4">
                    <h3 class="section-header mb-2">Issued Unclaimed Shares</h3>
                    {#if storageData?.issued_unclaimed_shares2}
                    <table class="w-full border-collapse">
                        <thead>
                            <tr>
                                <th class="text-left p-2 table-header">Registry Number</th>
                                <th class="text-center p-2 table-header">Issuer</th>
                                <th class="text-right p-2 table-header">Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            {:else}
                            <tr class="table-row">
                                <td class="text-center p-2 text-[color:var(--muted-foreground)]" colspan="3">No unclaimed shares</td>
                            </tr>
                            {/if}
                        </tbody>
                    </table>
                ...
                <div class="mt-4">
                    <h3 class="section-header mb-2">Owned Company Shares</h3>
                    <table class="w-full border-collapse">
                        <thead>
                            <tr>
                                <th class="text-left p-2 table-header">Address</th>
                                <th class="text-right p-2 table-header">Shares owned</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            {:else}
                                <tr class="table-row">
                                    <td class="text-center p-2 text-[color:var(--muted-foreground)]" colspan="2">No shares owned</td>
                                </tr>
                            {/if}
                        </tbody>
                    </table>
        ...
        <div>
            {#if tzktStorageData}
            <div class="mb-8 card">
                <h2 class="section-header mb-4">Contract Storage (TzKT API)</h2>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Registry Number:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.registry_number || 'Not set'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Max Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.max_shares || 'Not set'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Issued Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.issued_shares}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Allocated Shares:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.allocated_shares}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">All Shares Issued:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.all_shares_issued ? 'Yes' : 'No'}</span>
                    </div>
                    <div>
                        <span class="font-semibold text-[color:var(--primary)]">Contract admin:</span> 
                        <span class="text-[color:var(--foreground)]">{tzktStorageData.admin_address}</span>
                    </div>
                </div>
